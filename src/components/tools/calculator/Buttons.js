import { ButtonGroup } from "../../styles/calculator-styles/CalcBody.style";
...
function Buttons(props) {
  ...
  return (
    <>
      <ButtonGroup>
        <Button value="c" propsOb={propsOb}>
          {/* prettier-ignore */}
          <svg xmlns="http://www.w3.org/2000/svg" width="3em" height="3em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="#898989" d="M11 7a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-1h-2v1h-2V9h2v1h2V9a2 2 0 0 0-2-2h-2Z"/></svg>
        </Button>
        ...
        <Button value="/" propsOb={propsOb}>
          {/* prettier-ignore */}
          <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><g fill="white"><path d="M5 11a1 1 0 1 1 0-2h10a1 1 0 1 1 0 2H5Z"/><circle cx="10" cy="5.5" r="1.5"/><circle cx="10" cy="14.5" r="1.5"/></g></svg>
        </Button>
      </ButtonGroup>
      <ButtonGroup>
        <Button value="7" propsOb={propsOb}>
          {/* prettier-ignore */}
        ...
        <Button value="8" propsOb={propsOb}>
          {/* prettier-ignore */}
          <svg xmlns="http://www.w3.org/2000/svg" width="0.8em" height="1.1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 320 512"><path fill="#728ab7" d="M267.5 249.2C290 226.1 304 194.7 304 160c0-70.58-57.42-128-128-128h-32C73.42 32 16 89.42 16 160c0 34.7 13.99 66.12 36.48 89.19C20.83 272.5 0 309.8 0 352c0 70.58 57.42 128 128 128h64c70.58 0 128-57.42 128-128c0-42.2-20.8-79.5-52.5-102.8zM144 96.01h32c35.3 0 64 28.7 64 64s-28.7 64-64 64h-32c-35.3 0-64-28.7-64-64s28.7-64 64-64zM192 416h-64c-35.3 0-64-28.7-64-64s28.7-64 64-64h64c35.3 0 64 28.7 64 64s-28.7 64-64 64z"/></svg>
        </Button>
        <Button value="9" propsOb={propsOb}>
          {/* prettier-ignore */}
          <svg xmlns="http://www.w3.org/2000/svg" width="0.8em" height="1.1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 320 512"><path fill="#728ab7" d="M160 32.01c-88.22 0-160 71.78-160 160c0 85.57 67.71 155.1 152.3 159.2l-64.65 76.06c-11.47 13.45-9.812 33.66 3.656 45.09c6 5.125 13.38 7.62 20.72 7.62c9.062 0 18.06-3.823 24.38-11.28C281.9 297.5 320 266.6 320 192c0-88.2-71.8-159.99-160-159.99zM160 288c-52.94 0-96-43.06-96-95.1s43.06-96 96-96s96 43.06 96 96s-43.1 95.1-96 95.1z"/></svg>
        </Button>
        <Button value="*" propsOb={propsOb}>
          {/* prettier-ignore */}
      ...
      <ButtonGroup>
        ...
        <Button value="2" propsOb={propsOb}>
          {/* prettier-ignore */}
        ...
        <Button value="3" propsOb={propsOb}>
          {/* prettier-ignore */}
          <svg xmlns="http://www.w3.org/2000/svg" width="0.63em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 320 512"><path fill="#728ab7" d="M320 344c0 74.98-61.02 136-136 136h-80.4c-46.34 0-87.31-29.53-101.1-73.48c-5.594-16.77 3.484-34.88 20.25-40.47c16.75-5.609 34.89 3.484 40.47 20.25a43.38 43.38 0 0 0 41.23 29.7H184c39.7 0 72-32.3 72-72s-32.3-72-72-72H80c-13.2 0-25.05-8.094-29.83-20.41c-4.78-12.29-1.51-26.29 8.21-35.19L189.78 96H32C14.33 96 0 81.67 0 64s14.33-32 32-32h240c13.2 0 25.05 8.094 29.83 20.41c4.781 12.3 1.516 26.27-8.203 35.19L162.227 208H184c74.1 0 136 61 136 136z"/></svg>
        </Button>
        <Button value="+" propsOb={propsOb}>
          {/* prettier-ignore */}
          <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="white" stroke="white" strokeLinecap="round" strokeWidth="2" d="M12 20v-8m0 0V4m0 8h8m-8 0H4"/></svg>
        </Button>
      </ButtonGroup>
      <ButtonGroup>
        <Button value="0" propsOb={propsOb}>
          {/* prettier-ignore */}
          <svg xmlns="http://www.w3.org/2000/svg" width="0.63em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 320 512"><path fill="#728ab7" d="M160 32.01c-88.37 0-160 71.63-160 160v127.1c0 88.37 71.63 160 160 160s160-71.63 160-160V192c0-88.4-71.6-159.99-160-159.99zM256 320c0 52.93-43.06 96-96 96c-52.93 0-96-43.07-96-96V192c0-52.94 43.07-96 96-96c52.94 0 96 43.06 96 96v128z"/></svg>
        </Button>
        <Button value="." propsOb={propsOb}>
          <p>.</p>
        </Button>
        <Button value="=" propsOb={propsOb}>
          {/* prettier-ignore */}
          <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32"><path fill="white" d="M5.063 7C3.381 7 2 8.343 2 10c0 1.647 1.381 3 3.063 3h21.874C28.618 13 30 11.657 30 10c0-1.647-1.372-3-3.063-3H5.063Zm0 12C3.381 19 2 20.343 2 22c0 1.647 1.381 3 3.063 3h21.874C28.618 25 30 23.657 30 22c0-1.647-1.372-3-3.063-3H5.063Z"/></svg>
        </Button>
      </ButtonGroup>
    </>
  );
