  ...
  return (
    <>
      ...
      <ButtonGroup>
        ...
        <StyledButton value="." className="dot">
          <p>.</p>
        </StyledButton>
        <StyledButton value="=" className="equal equals">
          {/* prettier-ignore */}
