...
function Buttons({value, setValue}) {
  return (
    <>
      <ButtonGroup>
        <Button value="c" values={value} setValue={setValue}>
          {/* prettier-ignore */}
          <div><svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="#898989" d="M11 7a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-1h-2v1h-2V9h2v1h2V9a2 2 0 0 0-2-2h-2Z"/></svg></div>
        </Button>
        <Button value="+-" values={value} setValue={setValue}>
          <p>+/-</p>
        </Button>
        <Button value="%" values={value} setValue={setValue}>
          <p>%</p>
      ...
      <ButtonGroup>
        ...
        <Button value="6" values={value} setValue={setValue}>
          {/* prettier-ignore */}
      ...
      <ButtonGroup>
        ...
        <Button value="3" values={value} setValue={setValue}>
          {/* prettier-ignore */}
