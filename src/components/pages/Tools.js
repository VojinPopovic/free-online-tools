...
function Projects() {
  ...
  const [divBackground, setDivBackground] = useState(background);
  let color = "#FCBA04";
  ...
  return (
    <>
      ...
      <DivCenter
        ...
        borderRadius="10%"
      >
        <UnitConverter setDivBackground={setDivBackground} />
        <Button left="0" color={color}>
          {/* prettier-ignore */}
